...
int main()
{
    ...
    while(T--)
    {
        ...
        for(int i = 1; i <= N; i++)
        {
            ...
            if(i == 1) Vec.push_back(Value), Set.erase(Value), Max = Value;
            else
            {
                if(Value > Max) Vec.push_back(Value), Set.erase(Value), Max = Value;
                else
                {
                    int Front = *Set.begin();
                    if(Front < Max) Vec.push_back(Front), Set.erase(Front);
                    else
                    {
                        cout << "-1" << endl;
                        MinusOne = true;
