...
i64 n, m, array1[2005], array2[2005], array3[2005];

bool ok(i64 x)
{
    for(int i = 0; i < n; ++i)
    {
        array3[i] = (array1[i] + x) % m;
    }
...
int main()
{
    ...
    for(int i = 0; i < n; ++i) scanf("%I64d", &array1[i]);
    for(int i = 0; i < n; ++i) scanf("%I64d", &array2[i]);

    sort(array2, array2 + n);

    vector<i64> candidate;
    for(int i = 0; i < n; ++i)
    {
        if(array1[0] > array2[i]) candidate.push_back(m - abs(array1[0] - array2[i]));
        else candidate.push_back(abs(array1[0] - array2[i]));
    }
