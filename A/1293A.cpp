...
int main()
{
    ...
    while(t--)
    {
        ...
        if(!closed[s]) cout << "0" << endl;
        else
        {
            i64 up = 10000000000000000, down = -10000000000000000;

            for(i64 i = s + 1; i <= min(s + k + 5LL, n); ++i){
                    if(closed[i] == 0){
                            up = i;
                            break;
                    }
            ...
            for(i64 i = s - 1; i >= max(1LL, s - k - 5LL); --i){
                    if(closed[i] == 0){
                            down = i;
                            break;
                    }
            ...
            cout << min(abs(up - s), abs(down - s)) << endl;
        }
    }
